...
* Среднее процента решенных студентом задач относительно всех пробуемых им задач - т.е. если студент пробовал решить 8 задач, но решил в итоге только 6, то будет 75%. Считаю для каждого студента и усредняю.
