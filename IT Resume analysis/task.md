...
* Сколько у студента ушло попыток на решение задачи - покажет прогресс студентов по задачам.
...
##### Итог
Преподавель сможет посмотреть, насколько легко или тяжело у студента получилась та или иная задача.
...
Для нахождения процента успешных попыток для каждой задачи
