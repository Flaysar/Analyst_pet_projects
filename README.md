...
|---	|---	|---	|---	|
|[Итоговая работа](https://github.com/Flaysar/Analyst_pet_projects/tree/main/IT%20Resume%20analysis) | Анализ образовательной платформы | Задача исследования - Построение аналитики для корпоративных клиентов образовательной платформы IT Resume | `SQL`, `PostgreSQL`|
